...
test('image usage attributes output tokens to the image modality without output details', function () {
...
test('image usage honors output token details when present', function () {
    Http::fake(['*' => Http::response([
        'data' => [[
            'b64_json' => base64_encode('fake-image'),
        ]],
